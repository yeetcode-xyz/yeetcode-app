                            ...
                            .map((user, index) => {
                              ...
                              return (
                                ...
                                >
                                  ...
                                  <td className="text-center px-4 py-3 font-bold text-orange-500">
                                    {user.today}
                                  </td>
                                </tr>
                              );
                  ...
                  <div className="space-y-3">
                    ...
                    >
                      ...
                      <div className="text-right">
                        ...
                        <div className="w-16 h-1.5 bg-gray-200 rounded-full mt-1">
                          <div className="w-2/3 h-1.5 bg-orange-500 rounded-full"></div>
                        </div>
                      </div>
                    </div>
                    <div
                    ...
                    >
                      ...
                      <div className="text-right">
                        ...
                        <span className="inline-block bg-blue-500 text-white px-2 py-0.5 text-xs rounded mt-1 border border-blue-500">
                          NEW
                        </span>
                      </div>
                    </div>
